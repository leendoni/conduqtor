...
"[project]/src/lib/frame/registry.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const GROUP_LABELS = PALETTE_GROUPS.reduce(_c = (acc, g)=>{
    acc[g.key] = g.label;
    return acc;
}, {});
_c1 = GROUP_LABELS;
...
var _c, _c1;
__turbopack_context__.k.register(_c, "GROUP_LABELS$PALETTE_GROUPS.reduce");
__turbopack_context__.k.register(_c1, "GROUP_LABELS");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/lib/frame/codegen.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function buildAttrs(node, opts = {}) {
    const schema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getComponent"])(node.component);
    const out = [];
...
function getComponentSafe(key) {
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getComponent"])(key);
        return true;
    } catch  {
        return false;
    }
...
function ensureComponentImport(ctx, key) {
    const schema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getComponent"])(key);
...
"[project]/src/lib/frame/defaults.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createStarterTree() {
    ...
    const card = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNode"])("card");
    ...
    card.children = [];
    const cardInner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNode"])("flex-col");
    cardInner.props.className = "flex flex-col gap-3";
    cardInner.children.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNode"])("button"));
    const inputNode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNode"])("input");
    ...
    const row = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNode"])("flex-row");
    const b1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNode"])("badge");
    b1.props.text = "Beta";
    b1.props.variant = "secondary";
    const b2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNode"])("badge");
    b2.props.text = "v0.1";
...
"[project]/src/lib/frame/store.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$defaults$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/frame/defaults.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/frame/registry.ts [app-client] (ecmascript)");
...
/** Stable fallback root used before hydration completes (avoids getServerSnapshot loop). */ const FALLBACK_ROOT = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$defaults$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRootNode"])();
// ---------------------------------------------------------------------------
...
function nanoid10() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nanoid$2f$index$2e$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["nanoid"])(10);
}
/** Map a component key to its "primary text" prop key (first content-group prop, preferring text/title/value/label). */ function getPrimaryTextKey(componentKey) {
    const schema = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COMPONENTS"][componentKey];
...
const useFrameStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        documents: [],
        ...
        // ── document ops ───────────────────────────────────────────────────────
        newDocument: (name)=>{
            const doc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$defaults$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["newDocument"])(name);
            set((s)=>({
                    documents: [
                        ...s.documents,
                        doc
        ...
        deleteDocument: (id)=>{
            set((s)=>{
                ...
                if (docs.length === 0) {
                    const fresh = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$defaults$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["newDocument"])();
                    return {
                        documents: [
                            fresh
                        ],
        ...
        insertNode: (parentId, key, index)=>{
            const newNode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNode"])(key);
        ...
        group: (ids)=>{
            ...
            mutateActiveDoc(set, get, (doc)=>{
                ...
                const groupNode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$registry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNode"])("flex-col");
                ...
                if (raw) {
                    ...
                    if (Array.isArray(parsed.documents) && parsed.documents.length > 0) {
                        set({
                            ...
                            activeDocumentId: parsed.activeDocumentId && parsed.documents.some((d)=>d.id === parsed.activeDocumentId) ? parsed.activeDocumentId : parsed.documents[0].id,
                            saveStatus: "saved",
        ...
        exportJSON: ()=>{
            const doc = get().getActiveDocument();
            return doc ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$codegen$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateJSON"])(doc) : "{}";
        },
        importJSON: (raw)=>{
            try {
                const doc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$codegen$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseJSON"])(raw);
...
function seedDefault(set) {
    const doc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$frame$2f$defaults$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["newDocument"])();
    set({
        documents: [
            doc
        ],
...
function useActiveDocument() {
    ...
    return useFrameStore({
        "useActiveDocument.useFrameStore": (s)=>s.documents.find({
                "useActiveDocument.useFrameStore": (d)=>d.id === s.activeDocumentId
            }["useActiveDocument.useFrameStore"])
    }["useActiveDocument.useFrameStore"]);
}
_s(useActiveDocument, "L7tOZcCBMULYtcVXau+AO22DVhQ=", false, function() {
    return [
        useFrameStore
    ];
});
function useTree() {
    _s1();
    return useFrameStore({
        "useTree.useFrameStore": (s)=>s.documents.find({
                "useTree.useFrameStore": (d)=>d.id === s.activeDocumentId
            }["useTree.useFrameStore"])?.tree ?? FALLBACK_ROOT
    }["useTree.useFrameStore"]);
}
_s1(useTree, "L7tOZcCBMULYtcVXau+AO22DVhQ=", false, function() {
    return [
        useFrameStore
    ];
});
...
//# sourceMappingURL=src_lib_frame_01jk8ng._.js.map